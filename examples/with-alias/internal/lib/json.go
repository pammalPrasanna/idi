...
func (i *rootApp) JSON(w http.ResponseWriter, status int, data any) error {
	return i.JSONWithHeaders(w, status, data, nil)
}

func (i *rootApp) JSONWithHeaders(w http.ResponseWriter, status int, data any, headers http.Header) error {
...
func (i *rootApp) DecodeJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	return i.decodeJSON(w, r, dst, false)
}

func (i *rootApp) DecodeJSONStrict(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	return i.decodeJSON(w, r, dst, true)
}

func (i *rootApp) decodeJSON(w http.ResponseWriter, r *http.Request, dst interface{}, disallowUnknownFields bool) error {
	maxBytes := 1_048_576
